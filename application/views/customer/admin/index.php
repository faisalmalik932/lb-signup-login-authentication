                    ...
                    <div class="card no-border  no-margin">
                      <div class="padding-15">
                        <div class="item-header clearfix">
                          <div class="thumbnail-wrapper d32 circular">
                            <img width="40" height="40" src="<?php echo base_url()?>admin_assets/img/profiles/3x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/3.jpg" data-src-retina="assets/img/profiles/3x.jpg" alt="">
                          </div>
                      ...
                      <div class="relative">
                        ...
                        <div class="widget-19-post no-overflow">
                          <img src="<?php echo base_url()?>admin_assets/img/social-post-image.png" class="block center-margin relative" alt="Post">
                        </div>
                      </div>
                      <div class="padding-15">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/1x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/1.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/1x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/2x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/2.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/2x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/3x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/3.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/3x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/4x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/4.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/4x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/5x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/5.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/5x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/6x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/6.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/6x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/7x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/7.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/7x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/8x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/8.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/8x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/9x.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/9.jpg" src="<?php echo base_url()?>admin_assets/img/profiles/9x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="<?php echo base_url()?>admin_assets/img/profiles/avatar_small.jpg" alt="" data-src="<?php echo base_url()?>admin_assets/img/profiles/avatar_small.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg">
                  </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="<?php echo base_url()?>admin_assets/img/logo.png" alt="logo" data-src="<?php echo base_url()?>admin_assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="<?php echo base_url()?>admin_assets/img/profiles/avatar.jpg" data-src="<?php echo base_url()?>admin_assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar2x.jpg" alt="">
                    </div>
                  </div>
